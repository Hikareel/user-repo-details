...
data class RepoJson (
  ...
  @SerializedName("permissions") val permissions: Permissions = Permissions(),
  @SerializedName("security_and_analysis") val securityAndAnalysis: SecurityAndAnalysis = SecurityAndAnalysis()
