...
class GitHubServiceTest{
	...
	fun usernameCorrect(){
		...
		val repos = listOf(
			Repository("git-consortium",
				listOf(
					Branch("master", "b33a9c7c02ad93f621fa38f0e9fc9e867e12fa0e")
				)),
			Repository("hello-worId",
				listOf(
					Branch("master", "7e068727fdb347b685b658d2981f8c85f7bf0585")
				)),
			...
			Repository("test-repo1",
				listOf(
					Branch("gh-pages", "57523742631876181d95bc268e09fb3fd1a4d85e")
				))
		)
